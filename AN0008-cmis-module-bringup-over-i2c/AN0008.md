...
> **Draft, revision 0.4.** Every command in Section 5 has been run, and every output shown
...
| 0.4 | 3 September 2026 | Shared utility at 1.1, which adds the SPIMCI rows AN0011 needs. Self-check output re-run and unchanged apart from the version it prints. |
